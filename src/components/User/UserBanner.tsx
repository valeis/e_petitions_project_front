        ...
        <VStack align="left" spacing={4}>
          <Text color={"white"} fontSize={{ base: "14px", md: "16px" }}><b>Adresă email: </b>{user["email "]}
            ...
            {petitions.user_petitions && (
                <Text color={"white"} fontSize={{ base: "14px", md: "16px" }}><b>Numărul de petiții postate: </b>{Object.keys(petitions.user_petitions).length}</Text>
            )}
            {votedPetitions.user_voted_petitions && (
                <Text  color={"white"} fontSize={{ base: "14px", md: "16px" }}><b>Numărul de petiții votate: </b>{Object.keys(votedPetitions.user_voted_petitions).length}</Text>
            )}
        </VStack>
      </Box>
</Container>
